...
const int BACKGROUND_RED = 1;
const int BACKGROUND_GREEN = 2;
...
{
	if (mBackgroundColor == BACKGROUND_RED) 
	{
	...
	else if (mBackgroundColor == BACKGROUND_GREEN)
	{
		// Set draw color to red
		SDL_SetRenderDrawColor(
			mRenderer,
	...
	else if (mBackgroundColor == BACKGROUND_BLUE)
	{
